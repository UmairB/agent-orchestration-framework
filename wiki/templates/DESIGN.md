<!--
  DESIGN.md — answers ONE question: how should it look and feel, and why?
  Owner: designer.  Conditional (only if there is UI).
  Does NOT contain: UI BEHAVIOUR (→ tasks/*.feature). "The form offers Telnyx" is a behavioural
...
<!-- The user-visible BEHAVIOUR is specified as scenarios, not here. Link to them. -->

- <behaviour> — see `tasks/<area>.feature`
